...
= 1.3.9 =
* Added Fancybox for wordpress to recommended plugins
* Added Simple custom post order to recommended plugins
* Added Coing Soon & Maintenance Mode by Colorlib to recommended plugins
* Added Colorlib 404 Customizer to recommended plugins
* Removed Kiwi social share plugin from recommended plugins
